 ...
 * deploys from its own branch ({@code platform/main} by convention, the mirror of a tier's {@code
 * environment/<name>}), and is reachable from every environment by design. {@code main} is the
 * integration trunk on both planes and deploys nothing.
 *
 ...
 * citizen. {@code platform} is the vocabulary everywhere now: the enum, the container name ({@code
 * qits-pd-platform-<app>-<id8>}), the docker label ({@code
